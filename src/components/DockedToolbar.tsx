      ...
      <div className="flex items-center gap-2.5 text-xs font-normal text-zinc-400 select-none overflow-x-auto py-1">
        ...
        <div className="relative">
          <button
            ...
            className={`flex items-center gap-1 transition-colors hover:text-white px-2 py-1 rounded-md hover:bg-[#16161c] ${
              activePopover === 'pages' ? 'text-white bg-[#1c1c24]' : 'text-zinc-300'
            }`}
          ...
          {activePopover === 'pages' && (
            <div className="absolute bottom-full left-0 mb-3 w-68 bg-[#101014] border border-[#202026] rounded-xl shadow-2xl shadow-black p-4 text-zinc-200 z-50 animate-in fade-in slide-in-from-bottom-2 duration-150">
                ...
                {[1, 2, 3, 4, 5, 6, 7, 8].map((n) => (
                  <button
                    ...
                    className={`h-8 rounded-lg text-xs font-mono transition-all border ${
                      pageCount === n
                        ? 'bg-[#24242c] text-[#f4f4f6] font-semibold border-[#3e3e4c] shadow-xs'
                        : 'bg-[#09090c] border-[#1a1a20] text-zinc-400 hover:text-white hover:bg-[#14141a]'
                    }`}
                  >
                    {n}
                  </button>
              ...
              <div className="flex items-center gap-2 mb-3 pt-2 border-t border-[#18181f]">
                ...
                <input
                  ...
                  className="w-16 px-2 py-1 text-xs bg-[#09090c] border border-[#1a1a20] rounded text-white text-center font-mono focus:outline-hidden focus:border-zinc-500"
                />
              </div>
              ...
              <div className="pt-2 border-t border-[#18181f]">
                ...
                <div className="grid grid-cols-3 gap-1 bg-[#09090c] p-1 rounded-lg border border-[#1a1a20]">
                    ...
                    <button
                      ...
                      className={`py-1 text-[10px] rounded transition-colors ${
                        distributionMode === mode
                          ? 'bg-[#24242c] text-[#f4f4f6] font-medium border border-[#3e3e4c] shadow-xs'
        ...
        <div className="relative">
          <button
            ...
            className={`flex items-center gap-1.5 transition-colors hover:text-white px-2 py-1 rounded-md hover:bg-[#16161c] ${
              activePopover === 'font' ? 'text-white bg-[#1c1c24]' : 'text-zinc-300'
            }`}
          ...
          {activePopover === 'font' && (
            <div className="absolute bottom-full left-0 mb-3 w-64 bg-[#101014] border border-[#202026] rounded-xl shadow-2xl shadow-black p-3 text-zinc-200 z-50 animate-in fade-in slide-in-from-bottom-2 duration-150">
              ...
              <input
                ...
                className="w-full px-2.5 py-1.5 text-xs bg-[#09090c] border border-[#1a1a20] rounded-lg text-white mb-2 focus:outline-hidden focus:border-zinc-500"
              />
                  ...
                  <button
                    ...
                    className={`w-full px-2.5 py-1.5 rounded-md text-xs text-left flex items-center justify-between transition-colors ${
                      typography.fontFamily === font
                        ? 'bg-[#181820] text-white font-medium border border-[#2b2b36]'
        ...
        <div className="relative">
          <button
            ...
            className={`flex items-center gap-1.5 transition-colors hover:text-white px-2 py-1 rounded-md hover:bg-[#16161c] ${
              activePopover === 'size' ? 'text-white bg-[#1c1c24]' : 'text-zinc-300'
            }`}
          ...
          {activePopover === 'size' && (
            <div className="absolute bottom-full left-0 mb-3 w-72 bg-[#101014] border border-[#202026] rounded-xl shadow-2xl shadow-black p-4 text-zinc-200 z-50 animate-in fade-in slide-in-from-bottom-2 duration-150">
              <div className="flex items-center justify-between mb-3">
              ...
              {/* Auto-fit toggle */}
              <div className="flex items-center justify-between p-2 rounded-lg bg-[#09090c] border border-[#1a1a20] mb-3">
                ...
                <button
                  ...
                  className={`w-9 h-5 rounded-full p-0.5 transition-colors ${
                    advanced.autoFit ? 'bg-[#2b2b36] border border-[#484856]' : 'bg-[#18181e]'
                  }`}
                >
                  <div
                    className={`w-4 h-4 rounded-full transition-transform ${
                      advanced.autoFit ? 'translate-x-4 bg-zinc-100' : 'translate-x-0 bg-zinc-500'
                    }`}
                  />
                </button>
              </div>
              ...
              <div className="mb-3">
                ...
                <input
                  ...
                  className="w-full accent-zinc-300 h-1 bg-[#1a1a22] rounded cursor-pointer"
                />
              </div>
              ...
              <div className="mb-3">
                ...
                <div className="grid grid-cols-5 gap-1 bg-[#09090c] p-1 rounded-lg border border-[#1a1a20]">
                    ...
                    <button
                      ...
                      className={`py-1 text-[10px] rounded font-mono transition-colors ${
                        typography.fontWeight === w
                          ? 'bg-[#24242c] text-[#f4f4f6] font-medium border border-[#3e3e4c]'
                          : 'text-zinc-400 hover:text-zinc-200'
                      }`}
                    >
                      {w}
        ...
        {/* 5. Fill Canvas (Automated Wasted Black Space Eliminator) */}
        <button
          type="button"
          onClick={onFillCanvas}
          className="flex items-center gap-1.5 px-2.5 py-1 rounded-md text-[11px] font-medium transition-all border bg-[#14141a] border-[#22222c] text-zinc-300 hover:text-white hover:border-zinc-400 hover:bg-[#1a1a22]"
          title="1-click: Optimize font size, line height, and spacing to maximize page fill (~95-99% utilization) and eliminate empty black space"
        >
        ...
        {/* 6. Canvas Format / Ratio */}
        <div className="relative">
          <button
            type="button"
            onClick={() => togglePopover('format')}
            className={`flex items-center gap-1.5 transition-colors hover:text-white px-2 py-1 rounded-md hover:bg-[#16161c] ${
              activePopover === 'format' ? 'text-white bg-[#1c1c24]' : 'text-zinc-300'
            }`}
          ...
          {activePopover === 'format' && (
            <div className="absolute bottom-full left-0 mb-3 w-80 bg-[#101014] border border-[#202026] rounded-xl shadow-2xl shadow-black p-4 text-zinc-200 z-50 animate-in fade-in slide-in-from-bottom-2 duration-150">
              <span className="text-[10px] font-semibold text-zinc-500 uppercase font-mono tracking-wider block mb-2">
                Canvas Format
              </span>
                ...
                {[
                  ...
                  <button
                    ...
                    className={`w-full px-2.5 py-2 rounded-lg text-xs text-left flex items-center justify-between transition-colors border ${
                      canvas.preset === p.id
                        ? 'bg-[#1e1e28] border-zinc-500 text-white font-medium'
                        : 'bg-[#09090c] border-[#1a1a20] text-zinc-400 hover:text-white hover:bg-[#14141a]'
                    }`}
                  >
                    <span>{p.name}</span>
                ...
                <div className="grid grid-cols-2 gap-2">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-2 py-1 text-xs bg-[#09090c] border border-[#1a1a20] rounded text-white font-mono focus:outline-hidden focus:border-zinc-500"
                    />
                  </div>
                  <div>
        ...
        {/* 7. Horizontal Alignment Icons */}
        <div className="flex items-center bg-[#131318] p-0.5 rounded-lg border border-[#202026]">
          {[
        ...
        {/* 9. Margins (Popover Anchored DIRECTLY Above Button) */}
        <div className="relative">
          <button
            type="button"
            onClick={() => togglePopover('margins')}
            className={`flex items-center gap-1.5 transition-colors hover:text-white px-2 py-1 rounded-md hover:bg-[#16161c] ${
              activePopover === 'margins' ? 'text-white bg-[#1c1c24]' : 'text-zinc-300'
            }`}
          ...
          {activePopover === 'margins' && (
            <div className="absolute bottom-full right-0 mb-3 w-72 bg-[#101014] border border-[#202026] rounded-xl shadow-2xl shadow-black p-4 text-zinc-200 z-50 animate-in fade-in slide-in-from-bottom-2 duration-150">
              <span className="text-[10px] font-semibold text-zinc-500 uppercase font-mono tracking-wider block mb-2">
                Margins & Spacing
              </span>
                ...
                {[
                  ...
                  <button
                    ...
                    className={`py-1.5 px-2 rounded-lg text-xs flex flex-col items-center gap-0.5 border transition-colors ${
                      spacing.preset === m.id
                        ? 'bg-[#24242c] text-[#f4f4f6] font-medium border-[#3e3e4c] shadow-xs'
                        : 'bg-[#09090c] border-[#1a1a20] text-zinc-400 hover:text-white hover:bg-[#14141a]'
                    }`}
                  >
                    <span>{m.name}</span>
        ...
        {/* 10. More (···) (Popover Anchored DIRECTLY Above Button) */}
        <div className="relative">
          <button
            type="button"
            onClick={() => togglePopover('more')}
            className={`transition-colors hover:text-white text-sm tracking-widest px-2 py-1 rounded-md hover:bg-[#16161c] ${
              activePopover === 'more' ? 'text-white bg-[#1c1c24]' : 'text-zinc-400'
            }`}
          ...
          {activePopover === 'more' && (
            <div className="absolute bottom-full right-0 mb-3 w-80 bg-[#101014] border border-[#202026] rounded-xl shadow-2xl shadow-black p-4 text-zinc-200 z-50 animate-in fade-in slide-in-from-bottom-2 duration-150">
              <span className="text-[10px] font-semibold text-zinc-500 uppercase font-mono tracking-wider block mb-2">
                Colors & Appearance
              </span>
              <div className="space-y-2 mb-3 bg-[#09090c] p-2.5 rounded-lg border border-[#1a1a20]">
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex items-center gap-2">
                    <input
                      ...
                      className="w-6 h-6 rounded cursor-pointer border border-[#1a1a20] bg-transparent"
                    />
                ...
                <div className="pt-2 border-t border-[#18181f] flex items-center justify-between">
                  ...
                  <input
                    ...
                    className="rounded border-[#1a1a20] text-zinc-300 focus:ring-0"
                  />
                </div>
              </div>
              ...
              <div className="space-y-1.5 pt-2 border-t border-[#18181f]">
                <button
                  ...
                  className="w-full px-2.5 py-1.5 rounded-md text-xs text-left flex items-center gap-2 bg-[#09090c] border border-[#1a1a20] text-zinc-300 hover:text-white hover:bg-[#14141a] transition-colors"
                >
                ...
                <button
                  ...
                  className="w-full px-2.5 py-1.5 rounded-md text-xs text-left flex items-center gap-2 bg-[#09090c] border border-[#1a1a20] text-red-400 hover:text-red-300 hover:bg-red-950/20 transition-colors"
                >
